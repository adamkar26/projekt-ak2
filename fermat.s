...
movq k(,%rax,1), %r13  # liczba iteracji
cmp $4,%r11
jl pierwsza
movq $0, %r12 # licznik

sprawdzaj:
movq %r11, %rdi # przekazanie do funkcji
push %r11
call losuj  # wowluje funckje losujaca
pop %r11
movq %r11,%rdi
dec %rdi # potega o 1 mniejsza
push %r11  # liczba
push %rdi  # potega
push %rax  # wylosowana wartosc
call mod
add $24, %rsp  # sciagniecie ze stosu
cmp $1, %rax   # czy wynik rowny 1?
jne zlozona
inc %r12
cmp %r13,%r12
jl sprawdzaj
